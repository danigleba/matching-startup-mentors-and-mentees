        ...
        <div className="hero bg-[#f4f4f4] py-48 lg:py-0 lg:h-screen">
            <div className="mx-8 md:ml-20 md:mr-10">
                <div>
                    ...
                    <h1 className="z-30 text-3xl md:text-5xl">Turn your knoledge into<a className="bg-[#52b788] text-white px-2">cash</a></h1>
                    <p className="text-[#222222] text-center lg:text-left md:text-lg">Get equity in early-stage startups by mentoring their founders. Help them get Product-Market-Fit and turn your experience into an asset.
</p>
                </div>
